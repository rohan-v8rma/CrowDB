...
int main() {
    ...
    Node* rootNode = new Node("rohan", 12, 334.3, 9.7);
    rootNode->left = new Node("mohan", 12, 334.3, 9.7);
    rootNode->right = new Node("sohan", 12, 334.3, 9.7);
   ...
   printf("%p\n", rootNode);
    ...
    rootNode = deleteNode(rootNode, "rohan");
    printf("%p\n", rootNode);
